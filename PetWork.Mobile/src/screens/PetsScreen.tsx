...
const emptyForm: PetProfileRequest = { name: '', type: 'Kedi', breed: '', age: null, gender: 'Belirtilmedi', description: '', character: '', careNotes: '', childCompatibility: '', otherPetCompatibility: '', isVaccinated: null, isNeutered: null, isMicrochipped: null, tags: [], extraAttributes: {}, isPublic: true };
